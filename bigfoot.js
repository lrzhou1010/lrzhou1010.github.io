  ...
  (function($) {
    return $.bigfoot = function(options) {
      ...
      defaults = {
        ...
        buttonMarkup: "<div class='bigfoot-footnote__container'> <button class=\"bigfoot-footnote__button\" id=\"{{SUP:data-footnote-backlink-ref}}\" data-footnote-number=\"{{FOOTNOTENUM}}\" data-footnote-identifier=\"{{FOOTNOTEID}}\" alt=\"See Footnote {{FOOTNOTENUM}}\" rel=\"footnote\" data-bigfoot-footnote=\"{{FOOTNOTECONTENT}}\">" + 
        "<svg class='bigfoot-footnote__button__star' width='10' height='10'><defs><pattern id='image' patternUnits='userSpaceOnUse' height='10' width='10'><image x='0' y='0' height='10' width='10' xlink:href='footnote-button.png'></image></pattern></defs><rect width='10' height='10' fill='url(#image)'></rect></svg></button></div>"};
